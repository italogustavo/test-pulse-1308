    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Adicionar Filial</h3>
            </div>
            <?php echo form_open('filial/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="dsRazaoSocial" class="control-label">Razão Social</label>
						<div class="form-group">
							<input type="text" name="dsRazaoSocial" value="<?php echo $this->input->post('dsRazaoSocial'); ?>" class="form-control" id="dsRazaoSocial" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="nmApelidoFilial" class="control-label">Apelido da Filial</label>
						<div class="form-group">
							<input type="text" name="nmApelidoFilial" value="<?php echo $this->input->post('nmApelidoFilial'); ?>" class="form-control" id="nmApelidoFilial" />
						</div>
					</div>
					<div class="col-md-6">
