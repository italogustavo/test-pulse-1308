          		...
          		<div class="row clearfix">
					<div class="col-md-12">
						...
						<div class="form-group">
							<input type="text" name="nmUsuario" value="<?php echo $this->input->post('nmUsuario'); ?>" class="form-control" id="nmUsuario" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="cdLogin" value="<?php echo $this->input->post('cdLogin'); ?>" class="form-control" id="cdLogin" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="password" name="cdSenha" value="<?php echo $this->input->post('cdSenha'); ?>" class="form-control" id="cdSenha" />
						</div>
					</div>
				</div>
			</div>
